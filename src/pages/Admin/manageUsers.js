...
const UsersPage = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .catch((err) => setError("Error fetching departments"));
    }, []);
    ...
    const handleSubmit = (e) => {
        ...
        axios({
            ...
            .catch((err) => setError("Error saving user"));
    };
    ...
    return (
        ...
        <div className="member" style={{ marginTop: '1cm' }}>
            ...
            <h2 style={{ backgroundColor: "lightgreen", padding: "10px", borderRadius: "6px", margin: '0.4cm' }}>{editingUserId ? "Edit User" : "Add User"}</h2>
                ...
                <Row>
                    ...
                    <Col md={6}>
                        <Form.Group>
                            ...
                            <Form.Control type="text" name="phone" value={formData.phone} onChange={handleChange} placeholder="Phone" required />
                        </Form.Group>
                    </Col>
                </Row>
                ...
                <Row>
                    ...
                    <Col md={6}>
                        <Form.Group>
                            ...
                            <Form.Control type="text" name="rank" value={formData.rank} onChange={handleChange} placeholder="Rank" required />
                        </Form.Group>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col md={6}>
                        <Form.Group>
                            ...
                            <Form.Control type="text" name="armyid" value={formData.armyid} onChange={handleChange} placeholder="Army ID" required />
                        </Form.Group>
                    </Col>
                ...
                <tbody>
                    {currentUsers.map((user) => (
                        <tr key={user.id}>
                            ...
                            <td>{user.role}</td>
                            <td>
                                <Button style={{ border: "1px solid orange", backgroundColor: "white", color: "orange", margin: '2px' }}
                                    onClick={() => handleEdit(user)} variant="warning" className="mr-2">Edit</Button>
                                <Button style={{ border: "1px solid red", backgroundColor: "white", color: "green", margin: '2px' }}
